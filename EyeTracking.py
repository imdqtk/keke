...
with open(filename, mode='a', newline='') as file:
    ...
    # Ghi dòng tiêu đề nếu file chưa tồn tại
    if not file_exists:
        writer.writerow(["x", "y"])
...
class EyeTrackingApp:
    def __init__(self):
        ...
        self.filepath = None
         # Thêm nút "Add Image" và kết nối với hàm addImage()
        self.addImageButton = tk.Button(self.root, text="Add Image", command=self.addImage)
        self.addImageButton.pack()
        

        
    def addImage(self):
        filetypes = (("JPEG files", "*.jpg"), ("PNG files", "*.png"), ("All files", "*.*"))
        self.filepath = filedialog.askopenfilename(title="Select an image file", filetypes=filetypes)
    ...
    def start_eye_tracking(self):
            ...
            def render(self, image):
                if(self.visible):
                    ...
                    if(self.type == TYPE_CIRCLE):
                        ...
                        # Set font
                        font = ImageFont.truetype("UVNLacLongQuan_R.TTF", self.font)
        ...
        class EyeTracking:
            def __init__(self):
                ...
                # welcome messages
                self.pushText('Chào to the EyeTracker!', 100)
